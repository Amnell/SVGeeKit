...
| --- | ---: | --- |
| `passed` | 193 | Verified baseline in `Tests/__Snapshots__/` |
| `partialBaseline` | 110 | Renders; auto-tracked, needs human verification |
...
| `painting` | 31 | 21 | 0 | 9 | Tier 1 |
| `pservers` | 33 | 32 | 1 | 0 | Tier 1 |
