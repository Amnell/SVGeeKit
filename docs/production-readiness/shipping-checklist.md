...
- [ ] Tier-1 W3C tags at roadmap pass-rate targets (core tags ✓; `struct` 35/45+)
...
- [ ] `partialBaseline` count ≤30 across in-profile tags (see Phase 5; currently 76 total / 11 struct)
