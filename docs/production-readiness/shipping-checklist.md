...
- [ ] [security-model.md](security-model.md) Phase 0 checklist complete
- [ ] Tier-1 W3C tags at roadmap pass-rate targets
- [ ] `masking` chapter substantially passing
- [ ] System-font `text` working for typical labels
- [ ] `<marker>` or documented workaround in static profile
- [ ] `partialBaseline` count ≤30 across in-profile tags (see Phase 5)
